...
if ! command -v dnf 2>&1 >/dev/null; then
    ...
    sudo dnf install -qy hyprland hyprlock hypridle hyprpicker hyprshot hyprsunset swww SwayNotificationCenter cliphist hyprpolkitagent qt5-qtwayland qt6-qtwayland aylurs-gtk-shell2 nwg-look 
