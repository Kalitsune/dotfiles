...
deb_packages="npm zsh thefuck autojump tealdeer fzf neovim python3-neovim tmux zoxide gh xdpyinfo"
rhl_packages="npm zsh thefuck autojump-zsh tealdeer fzf neovim python3-neovim tmux zoxide gh xdpyinfo"
